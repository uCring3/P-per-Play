		...
		if card.puoabilita2 and giocatore == 1 and card.hoverposizionato and card.Mana <= player.Mana then
			if not card.abilita then
				if card.puoabilita then
					...
					elseif card.id == 2 then -- Ping
						elimina_cloni()
						card.abilita = false
						card.puoabilita = false
					elseif card.id == 3 then -- Cosmi
						draw_area = true
						attaccante = card
						card.puoabilita = false
					...
					elseif card.id == 24 then -- Fat Chad Yoshi
						annullare = true
						card.puoabilita = false
					elseif card.id == 25 then -- Disegni e Fan Art
						-- Ha una Abilità in Abilita:activeAbilitySummon(card)
						player.Mana = player.Mana + card.Mana
						card.abilita = false
						card.puoabilita = false
					elseif card.id == 26 then -- BAN
						-- Ha una Abilità in Abilita:activeAbilitySummon(card)
						player.Mana = player.Mana + card.Mana
						card.abilita = false
						card.puoabilita = false
					elseif card.id == 27 then -- Demon Core
						-- Ha una Abilità in Abilita:activeAbilitySummon(card)
						player.Mana = player.Mana + card.Mana
						card.abilita = false
						card.puoabilita = false
					elseif card.id == 28 then -- #memes
						-- Ha una Abilità in Abilita:activeAbilitySummon(card)
						player.Mana = player.Mana + card.Mana
						card.abilita = false
						card.puoabilita = false
					elseif card.id == 29 then -- Made in Haven
						-- Ha una Abilità in Abilita:activeAbilitySummon(card)
						player.Mana = player.Mana + card.Mana
						card.abilita = false
						card.puoabilita = false
					elseif card.id == 30 then -- Moyai
						-- Ha una Abilità in Abilita:activeAbilitySummon(card)
						player.Mana = player.Mana + card.Mana
						card.abilita = false
						card.puoabilita = false
					elseif card.id == 31 then -- Mortius
						-- Ha una Abilità in Abilita:activeAbilitySummon(card)
						player.Mana = player.Mana + card.Mana
						card.abilita = false
						card.puoabilita = false
					elseif card.id == 32 then -- Verelo
						-- Ha una Abilità in Abilita:activeAbilitySummon(card)
						player.Mana = player.Mana + card.Mana
						card.abilita = false
						card.puoabilita = false
...
function Abilita:activeAbilitySummon(card)
	...
	elseif card.id == 28 then -- #memes
		...
		card.morta = true
	elseif card.id == 29 then -- Made in Heaven
		if card.Mana <= player.Mana then
			player.Mana = player.Mana - card.Mana
			LOAD_MADE_IN_HEAVEN()
		else player.Mana = player.Mana+1
...
function Abilita:useAbility()
	...
	elseif PEPONE.bool then LOAD_MINION(100) end
end
