...
function Card:new(x,y, number, drawn, id)
	...
	cardObj.stato = {}
	cardObj.stato.avvelenata = false
	cardObj.stato.stordito = false
	cardObj.stato.immune = false
...
[[La carta obbiettivo è 
 ...
 da più tempo]]
	...
	elseif cardObj.id == 15 then -- Mostro di Firenze
		...
		cardObj.HP = cardObj.hp	
		cardObj.INFO.classe = "MEMBRO ONORARIO"
		cardObj.INFO.Tabilita1 = "Disabilità passiva"
		cardObj.INFO.tabilita1 = 
[[si elimina da sola
 dopo 2 turni]]
		cardObj.INFO.Tabilita2 = "Consiglio"
...
[[-100 ATK a ogni carta sul terreno avversario]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 1
 		cardObj.INFOlinee.tabilita2 = 1
	elseif cardObj.id == 36 then -- IL DVCE
		cardObj.Utente = true
		cardObj.Name = " IL DVCE"
		cardObj.ATK = 3000
		cardObj.Mana = 3
		cardObj.hp = 8000
		cardObj.HP = cardObj.hp	
		cardObj.INFO.classe = "MEMBRO ONORARIO"
		cardObj.INFO.Tabilita1 = "Abilità a evocazione"
		cardObj.INFO.tabilita1 = --da provare
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 44 then -- Perry
		cardObj.Utente = false
		cardObj.Name = "PERRY L'ORNITORINCO"
		cardObj.ATK = 0
		cardObj.Mana = 2
		cardObj.hp = 4000
		cardObj.HP = cardObj.hp	
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 45 then -- B per Basato
		cardObj.Utente = true
		cardObj.Name = "B PER BASATO"
		cardObj.ATK = 3000
		cardObj.Mana = 0
		cardObj.hp = 1500
		cardObj.HP = cardObj.hp	
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 46 then -- Summer
		cardObj.Utente = true
		cardObj.Name = "SUMMER"
		cardObj.ATK = 3000
		cardObj.Mana = 3
		...
		cardObj.INFO.classe = "ARTISTA"
		cardObj.INFO.Tabilita1 = "Abilità speciale"
		cardObj.INFO.tabilita1 = --da controllare
[[Bread:
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 47 then -- Gato Sburato
		cardObj.Utente = true
		cardObj.Name = "LAC REATURA"
		cardObj.ATK = 3500
		cardObj.Mana = 1
		cardObj.hp = 3500
		cardObj.HP = cardObj.hp	
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 48 then -- Bread
		cardObj.Utente = false
		cardObj.Name = "BREAD"
		cardObj.ATK = 0
		cardObj.Mana = 1
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 49 then -- Neco Arc
		cardObj.Utente = false
		cardObj.Name = "NECO ARC"
		cardObj.ATK = 0
		cardObj.Mana = 1
		cardObj.hp = 4000
		cardObj.HP = cardObj.hp	
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 50 then -- Sfango
		cardObj.Utente = false
		cardObj.Name = "SFANGO"
		cardObj.ATK = 0
		cardObj.Mana = 0
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 51 then -- Mr Caputo
		cardObj.Utente = true
		cardObj.Name = "MR CAPUTO"
		cardObj.ATK = 3000
		cardObj.Mana = 4
		cardObj.hp = 3500
		cardObj.HP = cardObj.hp	
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
 	elseif cardObj.id == 52 then -- Temmie Shop
		cardObj.Utente = false
		cardObj.Name = "TEMMIE SHOP"
		cardObj.ATK = 0
		cardObj.Mana = 3
		cardObj.hp = 4000
		cardObj.HP = cardObj.hp	
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
 	elseif cardObj.id == 53 then -- Sboro
		cardObj.Utente = false
		cardObj.Name = "SBORO"
		cardObj.ATK = 0
		cardObj.Mana = 1
...
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 54 then -- Death Note
		cardObj.Utente = false
		cardObj.Name = "DEATH NOTE"
		cardObj.ATK = 0
		cardObj.Mana = 4
		cardObj.hp = 4000
		cardObj.HP = cardObj.hp	
...
[[tutto in maiuscolo
 INVIO per confermare]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 1
 		cardObj.INFOlinee.tabilita2 = 2
	elseif cardObj.id == 55 then -- Local Troller
		cardObj.Utente = true
		cardObj.Name = "LOCAL TROLLER"
		cardObj.ATK = 3000
		cardObj.Mana = 20
		cardObj.hp = 2000
		cardObj.HP = cardObj.hp	
		cardObj.INFO.classe = "MEMBRO ONORARIO"
		cardObj.INFO.Tabilita1 = "Abilità segreta"
		cardObj.INFO.tabilita1 =
[[è un segreto]]
		cardObj.INFO.Tabilita2 = ""
		cardObj.INFO.tabilita2 = 
[[]]
 		...
 		cardObj.INFOlinee.Tabilita2 = 0
 		cardObj.INFOlinee.tabilita2 = 0
	elseif cardObj.id == 56 then -- Erba
		cardObj.Utente = false
		cardObj.Name = "ERBA"
		cardObj.ATK = 0
		cardObj.Mana = 15
...
function COLOR_CARDS(tavola)											--🎨
				--colore nome
	for s,self in ipairs(tavola) do
...
function SPAWN_CARD(x, y, number, drawn)
	if inventario.deck.total > 0 then
		local Randomid = math.random(1,inventario.deck.total)
...
function MUOVI_CARTA(numCartaLanciata)
	for i,card in ipairs(activeCards) do
		if (card.number > numCartaLanciata) and not card.posizionato then
...
local function LOAD_CARDS_STATS()
...
function DRAW_CARD_STATS(card,a,b,c,d,e,f,g,h,i,j,k,l,m,n)												--✏️
	...
	if card.Utente then
		love.graphics.draw(TOPBOT, TOPimg, g, h, card.r)
		love.graphics.setColor(1,1,1)										--🎨
		love.graphics.draw(TOPBOT, BOTimg, g, h+56, card.r)
	else
	...
	if card.Utente then --Utenti
		...
		love.graphics.rectangle("fill",card.x + 3*card.width/(11*k) , l-2.5, CARDstats.ATK.Width+20,CARDstats.ATK.Height)
		love.graphics.setColor(love.math.colorFromBytes(200,200,200,255))
		love.graphics.print("ATK: "..card.ATK,card.x + 3*card.width/(11*k) ,l, card.r, 1/4, 1/4)
			--Mana
		...
		if card.Mana < 10 then
			love.graphics.print(card.Mana, card.x+56+card.width/m, card.y-156+card.height/n, card.r, 1/3, 1/3, CARDstats.Mana.Width/3, CARDstats.Mana.Height*1.5)
		else
			love.graphics.print(card.Mana, card.x+51+card.width/m, card.y-156+card.height/n, card.r, 1/3, 1/3, CARDstats.Mana.Width/3, CARDstats.Mana.Height*1.5)
		end
			--HP
		love.graphics.setColor(love.math.colorFromBytes(100,100,100,220))
		love.graphics.rectangle("fill", 25+card.x + 3*card.width/(11*k) , 22.5+l, CARDstats.HP.Width,CARDstats.HP.Height)
		love.graphics.setColor(love.math.colorFromBytes(200,200,200,255))
		love.graphics.print("HP: "..card.HP, 25+card.x + 3*card.width/(11*k) , 25+l, card.r, 1/4, 1/4)
	else 		-- Reazioni
			--Mana
		love.graphics.setColor(love.math.colorFromBytes(250,250,250,255))
...
local function DRAW_INFO(card)
	love.graphics.setColor(1,1,1)											--🎨
		if ((card.hover) or (card.hoverposizionato) or (card.hoverposizionato2)) and (not card.morta) then
			--statishe testo
...
function Card:draw(card)
	...
	if not card.morta then																						--✏️
		...
		if card.posizionato then
			...
			--se immune
			if card.stato.immune then
				love.graphics.draw(IMMUNEimg, card.x , card.y, card.r)
			end
		else --non posizionate --in mano
				--se selezionata
			if card.hover then
				love.graphics.setColor(1,.2,.2)
				love.graphics.setLineWidth(5)
				love.graphics.rectangle("line", card.x-3+card.width/4, card.y-3+card.height/4, 6+card.width/2, 6+card.height/2)
			end
